...
import "./ReviewAcademiaSection.css";
...
function ReviewsAcademiaSection() {
  const reviews = [
    {
      alt: "Florencia C.",
      image: review1,
  ...
  return (
    <section className="reviewsAcademiaSection">
      <h2 className="ReviewAcademiaTitleSection">
      ...
      <div className="carouselContainer">
        ...
        <div className="controls">
          ...
          <div className="dotAcademiasAcademia">
            {Array.from({ length: maxIndex + 1 }).map((_, i) => (
              <button
                key={i}
                className={`dotAcademia ${index === i ? "active" : ""}`}
                onClick={() => setIndex(i)}
                aria-label={`Ir a ${i + 1}`}
              />
            ))}
...
export default ReviewsAcademiaSection;
